...
// Front vendor JS (order matters)
import '../vendor/jquery.animatedheadline.min.js';
...
import '../vendor/TextPlugin.js';
import '../vendor/customEase.js';
import '../vendor/jquery.meanmenu.min.js';
import '../vendor/backToTop.js';
import '../vendor/matter.js';
import '../vendor/throwable.js';
import '../vendor/waypoints.min.js';
import '../vendor/SplitText.min.js';
import '../vendor/jquery.carouselTicker.js';
// Local JS modules
...
(function ($) {
    ...
    // Register GSAP Plugins (only those that exist as globals)
    (function(){
        var plugins = [
            (globalThis && globalThis.ScrollTrigger) || (window && window.ScrollTrigger),
            (globalThis && globalThis.ScrollSmoother) || (window && window.ScrollSmoother),
            (globalThis && globalThis.CustomEase) || (window && window.CustomEase),
            (globalThis && globalThis.ScrollToPlugin) || (window && window.ScrollToPlugin)
        ].filter(Boolean);
        if (plugins.length && typeof gsap !== 'undefined' && typeof gsap.registerPlugin === 'function') {
    ...
    // text slider
    var textSliderEl = document.querySelector('.text-slider-active');
    if (textSliderEl && textSliderEl.querySelectorAll('.swiper-slide').length > 0) {
        var text_slider_active = new Swiper(textSliderEl, {
            slidesPerView: 'auto',
            loop: true,
            spaceBetween: 35,
            speed: 10000,
    ...
    // client slider
    var clientSliderEl = document.querySelector('.client-slider-active');
    if (clientSliderEl && clientSliderEl.querySelectorAll('.swiper-slide').length > 0) {
        var client_slider_active = new Swiper(clientSliderEl, {
            slidesPerView: 'auto',
            loop: true,
            spaceBetween: 0,
            speed: 5000,
